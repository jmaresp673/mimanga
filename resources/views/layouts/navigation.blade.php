<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 sm:mt-1 sm:mb-10 border-b container 2xl:max-w-7xl sm:rounded-full sm:mx-auto border-gray-100 dark:border-gray-700">
    <!-- Primary Navigation Menu -->
    <div class="sm:mt-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-dark-button class="sm:hidden"></x-dark-button>
