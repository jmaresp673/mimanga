    ...
    <template x-teleport="body">
        <div x-show="openModal"
            ...
            <div x-show="openModal"
                 ...
                 class="pb-16 sm:pb-0 text-gray-900 dark:text-white bg-white dark:bg-gray-800 rounded-t-xl sm:rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto transform transition-all"
                 @click.stop
                 x-cloak>
